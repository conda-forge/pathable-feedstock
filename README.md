...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pathable-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15317&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pathable-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pathable` can be installed with:

```
conda install pathable
```

It is possible to list all of the versions of `pathable` available on your platform with:
